...
[OBLIGATORIO. 2-3 líneas antes de cualquier teoría: qué problema real resuelve este tema, en qué tipo de tarea laboral concreta lo va a usar el alumno, y cómo conecta con lo aprendido antes. El objetivo es que el alumno entienda el "para qué" antes de ver la primera línea de código. Ejemplo para closures: "En cualquier app real necesitás que una función recuerde información entre llamadas sin contaminar el scope global — eso es lo que resuelven los closures. Sin este concepto no podrías entender cómo funcionan los módulos, los event listeners que guardan estado, ni el patrón factory que verás en Semi-Senior."]
...
Practicá respondiendo estas en voz alta o por escrito antes de buscar la respuesta. Son del tipo real que hacen en entrevistas para puestos Junior.

1. [Pregunta conceptual: "¿Qué es / explicá con tus palabras...?"]
2. [Pregunta de diferencia: "¿Cuál es la diferencia entre X e Y?"]
3. [Pregunta de código: snippet corto → "¿Qué imprime esto y por qué?"]
4. [Pregunta de aplicación: "¿Cuándo usarías X en lugar de Y?"]
5. [Pregunta de gotcha: algo que parece simple pero tiene comportamiento sorpresivo]

<details><summary>Ver respuestas orientativas</summary>

[Respuestas breves para cada pregunta, con el razonamiento explicado.]
</details>
